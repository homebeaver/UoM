 ...
 */
public class KorellerRCircle_icons_power implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private KorellerRCircle_icons_power() {
    ...
    public static RadianceIcon of(int width, int height) {
       KorellerRCircle_icons_power base = new KorellerRCircle_icons_power();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return KorellerRCircle_icons_power::new;
    }
}
