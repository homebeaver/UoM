 ...
 */
public class KorelleRCircle_icons_flame implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private KorelleRCircle_icons_flame() {
    ...
    public static RadianceIcon of(int width, int height) {
       KorelleRCircle_icons_flame base = new KorelleRCircle_icons_flame();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return KorelleRCircle_icons_flame::new;
    }
}
