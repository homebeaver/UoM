 ...
 */
public class KorellerRCircle_icons_arrow_down implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private KorellerRCircle_icons_arrow_down() {
    ...
    public static RadianceIcon of(int width, int height) {
       KorellerRCircle_icons_arrow_down base = new KorellerRCircle_icons_arrow_down();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return KorellerRCircle_icons_arrow_down::new;
    }
}
